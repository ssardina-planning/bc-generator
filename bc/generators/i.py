...
class Class_I_Generator(Generator):
    def __init__(self, n, min, max, l, m, k, d, seed):
        ...
        self.problem_name = 'class-I-%d-%d-%d-%d-%d-%d-%d-%d' % (seed, n, min, max, l, m, k, d)
        self.output_folder = 'class-I-%d/%d-%d-%d-%d-%d-%d-%d' % (seed, n, min, max, l, m, k, d)
        self.setup()
